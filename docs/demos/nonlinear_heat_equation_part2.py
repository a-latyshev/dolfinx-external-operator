...
evaluated_operators_F = evaluate_external_operators(F_external_operators, evaluated_operands)

evaluated_operators_J = evaluate_external_operators(J_external_operators, evaluated_operands)
